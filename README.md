...
For detailed architectural diagrams, subsystem deep dives, debugging guides, and development best practices, see [DEVELOPER.md](DEVELOPER.md).
...
The integration tests start the app and run live HTTP checks via [Tavern](https://tavern.readthedocs.io/).
...
### All checks (lint + format + security + tests)
